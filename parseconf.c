...
void parseconf_load_file(const char *path)
{
        ...
        if(fp == NULL)
                ERR_EXIT("parseconf_load_file:fopen");
...
void parseconf_load_setting(const char *setting)
{
        ...
        while(p_str_setting->p_setting_name != NULL)
        {
                ...
                p_str_setting++;
        }// end while(p_str_setting->p_setting_name != NULL)
        ...
        while(p_bool_setting->p_setting_name != NULL)
        {
                if(strcmp(p_bool_setting->p_setting_name,key) == 0)
                {
                 ...
                 p_bool_setting++;
        }// end while(p_bool_setting->p_bool_name != NULL)
        ...
        while(p_uint_setting->p_setting_name != NULL)
        {
                if(strcmp(p_uint_setting->p_setting_name,key) == 0)
                {
                 ...
                 p_uint_setting++;
        }// end while(p_uint_setting->p_uint_name != NULL)
